...
You can use these methods to test for significant differences between two
populations of functional data. Here is an example using the `TWT2` method on
the NASA temperatures data set:

```{r example, fig.retina=2, fig.dpi=300}
library(fdatest)
