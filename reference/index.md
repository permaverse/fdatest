...
- [`ITPaovbspline()`](https://permaverse.github.io/fdatest/reference/ITPaovbspline.md)
  : Interval Testing Procedure for testing unctional analysis of
  variance with B-spline basis
- [`ITPimage()`](https://permaverse.github.io/fdatest/reference/ITPimage.md)
  : Heatmap plot of the Interval Testing Procedure results
- [`ITPlmbspline()`](https://permaverse.github.io/fdatest/reference/ITPlmbspline.md)
  : Interval Testing Procedure for testing Functional-on-Scalar Linear
...
- [`autoplot(`*`<flm>`*`)`](https://permaverse.github.io/fdatest/reference/plot.flm.md)
  [`plot(`*`<flm>`*`)`](https://permaverse.github.io/fdatest/reference/plot.flm.md)
  : Plot for Functional Regression Test Results
- [`autoplot(`*`<ftwosample>`*`)`](https://permaverse.github.io/fdatest/reference/plot.ftwosample.md)
