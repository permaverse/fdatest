...
the global testing procedure for testing the significance of the effects
of scalar covariates on a functional population.
...
and `global_lm()` for calling a specific correction directly.
...
#> $call
#> functional_lm_test(formula = formula, correction = "Global", 
